  ...
  return (
    <div className="flex min-h-screen w-full bg-[#fcfcfc] text-gray-900 antialiased selection:bg-gray-100 relative z-[1]">
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-x-hidden">
        ...
        {/* Conteúdo da página */}
        <main className="flex-1 w-full max-w-[1200px] mx-auto px-6 py-6 sm:px-8 sm:py-8 md:px-12 md:py-8 animate-in fade-in duration-300">
          {children}
        </main>
